        ...
        while (conditionCreationCompte) {
            ...
            switch(choix) {
                case 1:
                    ...
                    boolean accountOkOrNok = fileGestion.verifAccountLogin("user.txt", valueLogin);
                    boolean accountOkOrNok2 = fileGestion.verifAccountPassword("user.txt", valuePin);

                    if (accountOkOrNok && accountOkOrNok2) {
